...
public class CreateEntityException : PersistenceException
{
    ...
    protected CreateEntityException(SerializationInfo info, StreamingContext context) { }
}
...
public class DeleteEntityException : PersistenceException
{
    ...
    protected DeleteEntityException(SerializationInfo info, StreamingContext context) { }
}
...
public class QueryEntityException : PersistenceException
{
    ...
    protected QueryEntityException(SerializationInfo info, StreamingContext context) { }
}
...
public class UpdateEntityException : PersistenceException
{
    ...
    protected UpdateEntityException(SerializationInfo info, StreamingContext context) { }
